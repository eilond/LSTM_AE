...
if __name__ == "__main__":
    ...
    plt.title('Daily maximal stock price of AMZN stock through 2014-2017', fontsize=20)
    plt.xlabel('Date', fontsize=20)
    plt.ylabel('Maximum stock price (USD)', fontsize=20)
    plt.grid(True)
    plt.show()

    plt.figure(figsize=(14, 7))
    plt.plot(amzn_data['date'], googl_daily_high_val)
    plt.title('Daily maximal stock price of GOOGL stock through 2014-2017', fontsize=20)
    plt.xlabel('Date', fontsize=20)
    plt.ylabel('Maximum stock price (USD)', fontsize=20)
    plt.grid(True)
    plt.show()
